...
module {
  ...
  public type Result_6 = { #Ok : NodeProvider; #Err : GovernanceError };
  public type Result_7 = { #Committed : Committed; #Aborted : {} };
  ...
  public type Service = actor {
    ...
    get_node_provider_by_caller : shared query Null -> async Result_6;
